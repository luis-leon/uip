...
public class AsignacionEncargadoUipTask
  implements JavaDelegate
{
    public void execute(DelegateExecution execution){
        RestTemplate restTemplate = new RestTemplate();
        DatosAsignacion respuesta = restTemplate.getForObject("https://rtu.desa.sat.gob.gt/api/service_asignaciones/asignacion-revisor?categoria=5", DatosAsignacion.class);
